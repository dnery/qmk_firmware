...
// // clang-format off
// combo_t key_combos[] = {
//     [SD_IS_LPARENS]  = COMBO(sd_combo, KC_LPRN),
//     [KL_IS_RPARENS]  = COMBO(kl_combo, KC_RPRN),
//     [WE_IS_LBRACE]   = COMBO(we_combo, KC_LBRC),
//     [IO_IS_RBRACE]   = COMBO(io_combo, KC_RBRC),
//     [DV_IS_LBRACKET] = COMBO(dv_combo, S(KC_LBRC)),
//     [NK_IS_RBRACKET] = COMBO(nk_combo, S(KC_RBRC)),
// };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_ansi_82(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            QK_MAKE,
        _______,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,  _______,  _______,  _______,  _______,  _______,              _______,            QK_REBOOT,
        _______,            _______,  _______,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,              _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,    _______,  _______,  _______,  _______),
};
